    ...
    return (
        <section className="container mx-auto 2xl:mt-10 xl:mt-7 sm:mt-5 mt-4 py-3 md:px-5 sm:px-7 px-3">
            ...
            <div className="relative flex flex-col">
                ...
                <button className="px-5 py-2 border bg-transparent border-zinc-700 text-zinc-700 rounded-full flex items-center font-semibold mx-auto mt-10 transition hover:text-zinc-600 hover:border-zinc-600 hover:bg-zinc-100" onClick={() => navigate(props.btn.link)}>
                    {props.btn.text}
