                                ...
                                <div className="container flex xl:space-x-10 space-x-8 mx-auto py-5 px-3">
                                   ...
                                   {subContntI &&  <div className="border-l border-gray-300 flex xl:flex-row flex-col 2xl:space-x-64 xl:space-x-44">
                                        <div className="xl:ml-14 ml-10">
                                            ...
                                            <Link to={SubLinks1[0].subhead.subheadlink.link}>
                                    ...
                                    {subContntII && <div className="border-l border-gray-300 flex xl:flex-row flex-col 2xl:space-x-20 xl:space-x-20">
                                        <div className="xl:ml-14 ml-10">
                                            ...
                                            <Link to={SubLinks1[1].subhead.subheadlink.link}>
                                                <span className="text-sm font-semibold cursor-pointer text-cyan-700 hover:underline">
                                                    ...
                                                    <li key={curVal.id} className="bg-transparent xl:my-4 my-2 border border-gray-200 rounded-md cursor-pointer transition transition-duration hover:bg-[#e1f7fa]">
                                                        <Link to={curVal.link}>
                                                            <div className="flex xl:flex-col flex-row xl:items-stretch items-center xl:w-40 w-50 h-full">
                                                                <img src={curVal.img} height={90} width={140} alt="card-image" className="xl:rounded-t-md rounded-l-md xl:rounded-b-none"  />
                                    ...
                                    {subContntIII &&  <div className="border-l border-gray-300 flex xl:flex-row flex-col 2xl:space-x-44 xl:space-x-24">
                                        <div className="xl:ml-14 ml-10">
                                            ...
                                            <Link to={SubLinks1[2].subhead.subheadlink.link}>
                                                <span className="text-sm font-semibold cursor-pointer text-cyan-700 hover:underline">
                ...
                <div className="flex items-center">
                    ...
                    {isAuthenticated ? (
                        <div className="flex items-center space-x-4">
                            ...
                            <Link 
                                to="/messages"
                                className="flex items-center space-x-2 text-zinc-700 hover:text-cyan-700"
                            >
                                <MessageNotification />
                            </Link>
                            <Link 
                                to="/dashboard"
                                className="text-zinc-700 hover:text-cyan-700"
                            >
                                Dashboard
                            </Link>
                            {user?.userType === 'ADMIN' && (
                            ...
                            <button 
                                className="text-zinc-700 text-[1.03rem] font-semibold hover:text-cyan-700 flex items-center space-x-1" 
                        ...
                        <>
                            ...
                            <button className="xl:mx-7 mx-3 text-zinc-700 text-[1.03rem] font-semibold hover:text-cyan-700" onClick={() => navigate("/account-security/login")}> 
                                LogIn 
                            </button>

                            <button className="font-semibold bg-gradient-to-tr from-sky-200 to-cyan-200 py-2 px-3 rounded-xl text-gray-800 hover:from-cyan-300 hover:to-sky-200" onClick={() => navigate("/account-security/signup")}> 
                                SignUp 
                            </button>
                        </>
                    )}
            ...
            <div className="lg:hidden">
                <div className="border-b border-gray-200 block">
                    <div className="flex justify-between sm:px-5 px-3 py-2">
                        ...
                        {/* ========= Left ========= */}
                        <button className="font-semibold py-1 px-3 rounded-xl text-gray-800 hover:text-cyan-800" onClick={() => navigate("/account-security/signup")}> 
                            SignUp 
                        </button>
                    </div>
                </div>
                ...
                <div className={`w-full absolute flex flex-col space-y-7 shadow-md z-20 lg:hidden sm:px-5 px-2 pt-2 pb-10 bg-[#F3FFFC] transition duration-100 linear  ${(mobilelist === true) ? "translate-x-[0%]" : "translate-x-[-100%]"}`}>
                    ...
                    <ul className="flex flex-col space-y-7 sm:mx-0 mx-1 z-10">
                                        ...
                                        <li key={curVal.id}>
                                            ...
                                            <div className={`my-3 mx-1 flex-col ${(curVal.id == `${se}`) ? "flex" : "hidden"}`}>
                                                ...
                                                <span className="text-sm font-md text-zinc-500">
                                                    {curVal.subhead.des}
                                                    <Link to={curVal.subhead.subheadlink.link}>
                        ...
                        <li>
                            <Link to="/messages" className="flex items-center justify-between font-semibold text-[1.03rem] hover:text-cyan-700 text-zinc-700">
                                Messages
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link to={"/enterprise"} className="text-zinc-700 text-[1.03rem] font-semibold hover:text-cyan-700"> 
                                Enterprise 
                            </Link>
                        </li>
                    </ul>
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className="flex items-center space-x-2">
                            <LanguageSwitcher size="small" showLabel={false} />
                            <button className="text-zinc-700 text-[1.03rem] font-semibold hover:text-cyan-700 inline-flex sm:mx-0 mx-1" onClick={() => navigate("/account-security/login")}>
                                Login
                            </button>
                        </div>
                    )}
